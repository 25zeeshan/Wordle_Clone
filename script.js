...
const inputGrid = document.querySelector("[data-input-grid]");
startInteraction();
...
function pressKey(key) {
    ...
    const nextTile = inputGrid.querySelector(":not([data-letter])");
...
function getActiveTiles() {
    return inputGrid.querySelectorAll("[data-state='active']");
}
...
function checkWinLose(guess, tiles) {
    ...
    const remainingTiles = inputGrid.querySelectorAll(":not([data-letter])");
...
function resetGame() {
    const Tiles = inputGrid.querySelectorAll(".tile");
